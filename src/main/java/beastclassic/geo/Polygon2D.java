...
//        System.err.println("parsing polygon");
    ...
    private void parseCoordinates(Element element) {
        ...
        if (element.getNodeName().equalsIgnoreCase(COORDINATES)) {
...
//        rescaleToPositiveCoordinates();
    ...
    public static void readKMLElement(Element element, List<Polygon2D> polygons) {
        ...
        if (element.getNodeName().equalsIgnoreCase(POLYGON)) {
    ...
    public static List<Polygon2D> readKMLFile(String fileName) throws SAXException, IOException, ParserConfigurationException  {
        ...
        if (!root.getNodeName().equalsIgnoreCase("KML"))
