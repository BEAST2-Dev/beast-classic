...
//		}
	...
	public void continuousPhylogeographyTestTutorial() throws Exception {
		...
		assertOperatorsEqual("treeScaler.t:RacRABV", "treeRootScaler.t:RacRABV", "UniformOperator.t:RacRABV", "SubtreeSlide.t:RacRABV", "narrow.t:RacRABV", "wide.t:RacRABV", "WilsonBalding.t:RacRABV", "StrictClockRateScaler.c:RacRABV", "strictClockUpDownOperator.c:RacRABV", "KappaScaler.s:RacRABV", "PopSizeScaler.t:RacRABV");
		assertPriorsEqual("CoalescentConstant.t:RacRABV", "ClockPrior.c:RacRABV", "KappaPrior.s:RacRABV", "PopSizePrior.t:RacRABV");
		assertTraceLogEqual("posterior", "likelihood", "prior", "treeLikelihood.RacRABV", "TreeHeight.t:RacRABV", "clockRate.c:RacRABV", "kappa.s:RacRABV", "popSize.t:RacRABV", "CoalescentConstant.t:RacRABV");
		...
		dialog2 = WindowFinder.findDialog("GuessTaxonSets").using(robot());
		dialog2.radioButton("split on character").click();
		dialog2.comboBox("splitCombo").selectItem("4");
		okButton = dialog.robot.finder().find(JButtonMatcher.withText("OK").andShowing());
		...
		assertStateEquals("Tree.t:RacRABV", "clockRate.c:RacRABV", "kappa.s:RacRABV", "popSize.t:RacRABV", "clockRate.c:location", "precisionMatrix.s:location");
		assertOperatorsEqual("treeScaler.t:RacRABV", "treeRootScaler.t:RacRABV", "UniformOperator.t:RacRABV", "SubtreeSlide.t:RacRABV", "narrow.t:RacRABV", "wide.t:RacRABV", "WilsonBalding.t:RacRABV", "StrictClockRateScaler.c:RacRABV", "strictClockUpDownOperator.c:RacRABV", "KappaScaler.s:RacRABV", "PopSizeScaler.t:RacRABV", "StrictClockRateScaler.c:location", "strictClockUpDownOperator.c:location");
		assertPriorsEqual("CoalescentConstant.t:RacRABV", "ClockPrior.c:RacRABV", "KappaPrior.s:RacRABV", "PopSizePrior.t:RacRABV", "ClockPrior.c:location");
		assertTraceLogEqual("posterior", "likelihood", "prior", "treeLikelihood.RacRABV", "TreeHeight.t:RacRABV", "clockRate.c:RacRABV", "kappa.s:RacRABV", "popSize.t:RacRABV", "CoalescentConstant.t:RacRABV", "clockRate.c:location", "precisionMatrix.s:location");		
		...
		assertStateEquals("Tree.t:RacRABV", "clockRate.c:RacRABV", "kappa.s:RacRABV", "popSize.t:RacRABV", "clockRate.c:location", "precisionMatrix.s:location");
		assertOperatorsEqual("treeScaler.t:RacRABV", "treeRootScaler.t:RacRABV", "UniformOperator.t:RacRABV", "SubtreeSlide.t:RacRABV", "narrow.t:RacRABV", "wide.t:RacRABV", "WilsonBalding.t:RacRABV", "StrictClockRateScaler.c:RacRABV", "strictClockUpDownOperator.c:RacRABV", "KappaScaler.s:RacRABV", "PopSizeScaler.t:RacRABV", "StrictClockRateScaler.c:location", "strictClockUpDownOperator.c:location");
		assertPriorsEqual("CoalescentConstant.t:RacRABV", "ClockPrior.c:RacRABV", "ClockPrior.c:location", "KappaPrior.s:RacRABV", "PopSizePrior.t:RacRABV");
		assertTraceLogEqual("posterior", "likelihood", "prior", "treeLikelihood.RacRABV", "TreeHeight.t:RacRABV", "clockRate.c:RacRABV", "kappa.s:RacRABV", "popSize.t:RacRABV", "CoalescentConstant.t:RacRABV", "clockRate.c:location", "precisionMatrix.s:location");
